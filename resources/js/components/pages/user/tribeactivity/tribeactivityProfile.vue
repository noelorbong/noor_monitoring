    ...
    <div class="col-sm-6 col-xl-3">
      <div class="card">
        <div class="card-header">
          ...
          <router-link
            :to="{name: 'TribeactivityProfileEdit', params: {id: userId}}"
            style="float:right;"
...
export default {
  ...
  methods: {
    ...
    saveData: function() {
      ...
      formData.append("tribeactivity_id", app.userId);
      formData.append("member_id", availability);
      axios
        .post("/auth/tribeactivity/storeattendees", formData)
        .then(function(resp) {
          console.log(resp);
    ...
    deleteEntry(id, index) {
      if (confirm("Do you really want to delete it?")) {
        var app = this;
        axios
          .delete("/auth/tribeactivity/deleteattendee/" + id + "/" + app.userId)
          .then(function(resp) {
