  ...
  <div>
    <div class="card">
      <div class="card-header">
        <i class="nav-icon fa fa-plus"></i> Edit Lifeclass
      </div>
...
export default {
  ...
  methods: {
    saveForm() {
      ...
      var data = app.data;
      axios
        .post("/auth/lifeclass/update", data)
        .then(function(resp) {
          console.log(resp);
          app.$router.push("/main/lifeclass/profile/" + app.data.id);
        })
        .catch(function(resp) {
          console.log(resp);
