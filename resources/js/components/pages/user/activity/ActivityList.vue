  ...
  <div class="vld-parent">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <!-- <router-link
          :to="{name: 'UserActivityCreate',  params: {id: mainId}}"
            ...
            <tbody>
              <tr v-for="(data) in searchResult" :key="data.id">
                ...
                <!-- <td style="width: 120px;">
                  <router-link
                    :to="{name: 'UserActivityProfileEdit', params: {id: data.id}}"
                    style="float:right;"
...
<script>
import LineExample from "./ActivityLineExample.vue";
...
export default {
  ...
  methods: {
    ...
    app.mainId = id;
    axios
      .get("/auth/user/activity/list/" + id+'/'+tribe_id)
      .then(function(resp) {
