    ...
    <div class="col-sm-6 col-xl-3">
      <div class="card">
        <div class="card-header">
          <i class="nav-icon fa fa-fort-awesome"></i> Category
          <router-link
            v-if="userId != 1"
            :to="{name: 'CategoryEdit' ,params: {id: userId}}"
            style="float:right;"
...
export default {
  ...
  methods: {
    ...
    loadActivity() {
      ...
      app.isLoading = true;
      axios
        .get("/auth/category/profile/" + id)
        .then(function(resp) {
          // console.log(resp.data);
          app.data = resp.data.user;
          app.filename = "category_" + resp.data.user.category_name + ".xls";
    ...
    saveData: function() {
      ...
      formData.append("category_id", app.userId);
      formData.append("member_id", availability);
      axios
        .post("/auth/category/member/update", formData)
        .then(function(resp) {
          console.log(resp);
    ...
    saveForm() {
      var app = this;
      app.member.category = app.userId;
    ...
    removeEntry(id) {
      ...
      if (confirm("Do you really want to remove it?")) {
        axios
          .delete("/auth/category/remove/" + id + "/" + app.userId)
          .then(function(resp) {
