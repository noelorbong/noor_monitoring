    ...
    <div class="col-sm-6 col-xl-3">
      <div class="card">
        <div class="card-header">
          ...
          <router-link
            v-if="userId != 1"
            :to="{name: 'LifeclassEdit' ,params: {id: userId}}"
            style="float:right;"
...
export default {
  ...
  methods: {
    ...
    saveData: function() {
      ...
      axios
        .post("/auth/lifeclass/member/update", formData)
        .then(function(resp) {
          console.log(resp);
    ...
    removeEntry(id) {
      ...
      if (confirm("Do you really want to remove it?")) {
        axios
          .delete("/auth/lifeclass/remove/" + id + "/" + app.userId)
          .then(function(resp) {
